...
\begin{tabular}{ll}
Espoo, Finland & \Email\myhref{mailto:vitaly.repin@gmail.com}{vitaly.repin@gmail.com}\\
...
\bf Experience &\textbf{05.2012 -- 04.2013. CBTec Oy. Helsinki, Finland. Chief software architect}\\[-.5cm]
& \begin{itemize}
\item Nokia N9 project. Details per request.
\item CTO functions for the startup company (eLearning). Details per request.
\end{itemize}\\[-.3cm]
